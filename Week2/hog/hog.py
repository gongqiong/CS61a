...
def roll_dice(num_rolls, dice=six_sided):
	...
	# BEGIN PROBLEM 1
	outcomes, pigout = 0, False
	for i in range(num_rolls):
		diceOnce = dice()
		if diceOnce == 1:
			pigout = True
		outcomes += diceOnce
	return (pigout and 1) or outcomes
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
	...
	# BEGIN PROBLEM 3
	if num_rolls == 0:
		outcomes = free_bacon(opponent_score)
	else:
		outcomes = roll_dice(num_rolls, dice)
	return outcomes
...
def is_swap(score0, score1):
	...
	# BEGIN PROBLEM 4
	if score0 != 1 and score1 != 1 and score0 != 0 and score1 != 0 and (score0 % score1 == 0 or score1 % score0 == 0):
		return True
	return False
